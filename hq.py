...
def show_not_on():
    ...
    if "broadcast" not in response_data or response_data["broadcast"] is None:
        if "error" in response_data and response_data["error"] == "Auth not valid":
           ...
           # embed.set_footer(text="Made By R€FL€X ॥乛♥P⃠𝙖 𝙧 𝙖 𝙢#0005")
        ...
        if msg.name == "text":
           ...
           # print(message_data)
            ...
            if message_data['type'] == 'question':
               ...
               # embd.set_footer(text=f"Made by R€FL€X ॥乛♥P⃠𝙖 𝙧 𝙖 𝙢#0005")
               ...
               # embed.add_field(name="● Prize Money :", value=f"5000$", inline=True)
                ...
                #embed.set_footer(text=f"Made By R€FL€X ॥乛♥P⃠𝙖 𝙧 𝙖 𝙢#0005")
                hook.send(embed=embed)
